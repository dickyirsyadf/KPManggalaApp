...
<style>
    ...
    .table tbody tr:hover { background-color: #f1f5f9; } /* Warna hover lebih lembut */
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{-- Cek apakah ada data preorder sebelum merender tabel --}}
                @if($semuaPreorder->isNotEmpty())
                    <div class="table-responsive">
                        <table class="table table-striped" id="preorderAdminTable">
                            ...
                            <tbody>
                                {{-- Menggunakan @foreach karena sudah dicek datanya tidak kosong --}}
                                @foreach ($semuaPreorder as $po)
                                <tr>
                ...
                @else
                    ...
                    <div class="alert alert-secondary text-center">
                        <p class="mb-0">Tidak ada pengajuan preorder saat ini.</p>
                    </div>
                @endif
...
{{-- PERUBAHAN: Skrip hanya akan dimuat dan dijalankan jika tabel ada --}}
@if($semuaPreorder->isNotEmpty())
