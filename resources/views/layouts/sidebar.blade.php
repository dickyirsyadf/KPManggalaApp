            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    ...
                    @if(auth()->user()->id_hakakses == 2)
                     <a href="{{ route('karyawan.dashboard') }}"><img src="{{asset('assets/compiled/mangony-logo.png')}}" alt="Logo" srcset="" style="height: 80px; width: auto;"></a>
                    @endif
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->is('dashboard') ? 'active' : '' }}">
                    ...
                    @elseif(auth()->user()->id_hakakses == 2)
